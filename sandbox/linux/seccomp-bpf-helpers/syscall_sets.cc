...
#if defined(__i386__) || defined(__x86_64__) || ( defined(__mips__) && (_MIPS_SIM == _MIPS_SIM_ABI32))
    case __NR_time:
#endif
      return true;
...
#if defined(__i386__) || ( defined(__mips__) && (_MIPS_SIM == _MIPS_SIM_ABI32))
...
#elif defined(__i386__) || defined(__arm__) || ( defined(__mips__) && (_MIPS_SIM == _MIPS_SIM_ABI32))
    case __NR_fstatat64:
#endif
#if defined(__i386__) || defined(__arm__)
    case __NR_lchown32:
...
bool SyscallSets::IsAllowedGeneralIo(int sysno) {
  switch (sysno) {
    ...
    case __NR_read:
    case __NR_readv:
#if defined(__arm__) || (defined(__mips__) && (_MIPS_SIM == _MIPS_SIM_ABI32))
    case __NR_recv:
#endif
#if defined(__x86_64__) || defined(__arm__) || defined(__mips__) || \
    defined(__aarch64__)
