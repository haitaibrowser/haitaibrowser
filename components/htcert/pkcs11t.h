...
#define CKM_SM1_ECB							 0x00010010
#define CKM_SM1_CBC							 0x00010011
...
typedef struct EVPPrivateKey
{
	int Version;    //INTEGER
	Octet AsymAlgID;  //IDENTIFIER
	Octet SymAlgID;    //IDENTIFIER
	Octet EncryptedSymKey; //OCTET STRING
	Octet EncryptedPrivateKey; //OCTET STRING
}EVPPrivateKey;
